...
export const METRICS: MetricDef[] = [
  ...
  { id: 'nearBidDepth', label: 'Near-touch Bid Depth', group: 'Passive liquidity', unit: 'usd' },
  { id: 'nearAskDepth', label: 'Near-touch Ask Depth', group: 'Passive liquidity', unit: 'usd' },
  { id: 'weightedBidDepth', label: 'Distance-weighted Bid Depth', group: 'Passive liquidity', unit: 'usd' },
  { id: 'weightedAskDepth', label: 'Distance-weighted Ask Depth', group: 'Passive liquidity', unit: 'usd' },
  { id: 'nearBookImbalance', label: 'Near-touch Book Imbalance', group: 'Passive liquidity', unit: 'ratio' },
  { id: 'bidReplenishmentRatio', label: 'Bid Replenishment Ratio', group: 'Passive liquidity', unit: 'ratio' },
  { id: 'askReplenishmentRatio', label: 'Ask Replenishment Ratio', group: 'Passive liquidity', unit: 'ratio' },
  { id: 'bidPersistence', label: 'Bid Persistence', group: 'Passive liquidity', unit: 'pct', hasPercentile: true },
  { id: 'askPersistence', label: 'Ask Persistence', group: 'Passive liquidity', unit: 'pct', hasPercentile: true },
  { id: 'passiveBuyerStrength', label: 'Passive Buyer Strength', group: 'Passive liquidity', unit: 'pct', hasPercentile: true },
  { id: 'passiveSellerStrength', label: 'Passive Seller Strength', group: 'Passive liquidity', unit: 'pct', hasPercentile: true },
  { id: 'defendedBidTests', label: 'Defended Bid Tests', group: 'Passive liquidity', unit: 'count' },
  { id: 'defendedAskTests', label: 'Defended Ask Tests', group: 'Passive liquidity', unit: 'count' },
  { id: 'hasPassiveLiquidity', label: 'Passive Book Measured', group: 'Passive liquidity', unit: 'bool' },
