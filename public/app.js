...
const ALERT_TF_MINUTES = [5, 15, 30, 60]; // evaluate stories on 5m, 15m, 30m and 1h bars
const ALERT_KEEP_1M = 720; // ~12h of 1m bars → enough prior for 5m / 15m / 30m / 1h vacuum context
