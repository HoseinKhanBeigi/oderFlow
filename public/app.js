...
const ALERT_TF_MINUTES = [5, 15]; // stop-hunt (and other alert stories) on 5m and 15m only
const ALERT_KEEP_1M = 720; // ~12h of 1m bars → enough prior for 5m / 15m vacuum context
